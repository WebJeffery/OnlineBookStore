...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="<c:url value='/frontpages/css/user/pwd.css'/>">
	...
	<div class="div1">
		...
		<table>
			<tr>
				...
				<td>
					<p>${msg}</p>
					<input class="input" type="password" name="loginpass" id="loginpass" value="${user.loginpass }"/></td>
			...
			<tr class="vertify">
				...
				<td>
					<p><label id="verifyCodeError" class="error"></label></p>
			...
			<tr>
				<td align="right"></td>
				<td><input id="submit" type="submit" value="修改密码" class="updatepwd"/></td>
			</tr>
		</table>
		</form>
	</div>

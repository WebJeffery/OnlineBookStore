...
a:hover {color:#FF6600; text-decoration: underline;}
  ...
  <c:choose>
  	<c:when test="${code eq 'success' }"><%--如果code是功能，它显示对号图片 --%>
  		<c:set var="img" value="/images/happy.jpg"/>
  		<c:set var="title" value="成功"/>
  	</c:when>
  	<c:when test="${code eq 'error' }"><%--如果code是功能，它显示错号图片 --%>
  		<c:set var="img" value="/images/unhappy.jpg"/>
...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<span style="font-size: 30px; color: #E4393C; font-weight: 900;">${msg }</span>
		<br/>
		<br/>
		<br/>
		<br/>
		  <span style="margin-left: 50px;"><a target="_top" href="<c:url value='/frontpages/user/login.jsp'/>">登录</a></span>
